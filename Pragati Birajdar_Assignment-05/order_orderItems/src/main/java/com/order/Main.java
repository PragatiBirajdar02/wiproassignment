...
public class Main {
    public static void main(String[] args) {
        ...
        // Create OrderItems
        OrderItem orderItem1 = new OrderItem(0, order, "pro1", 2);
        orderItemDAO.saveOrUpdate(orderItem1);
        System.out.println("Order item created: " + orderItem1);

        OrderItem orderItem2 = new OrderItem(0, order, "pro2", 5);
        ...
        System.out.println("Order items " + order.getId() + " after deleting: " + orderItems);
